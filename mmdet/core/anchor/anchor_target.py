...
def anchor_target_single(flat_anchors,
    ...
    if len(pos_inds) > 0:
        ...
        gt_device = bbox_weights[pos_inds, :].device
        bbox_weights[pos_inds, :] = bbox_weights[pos_inds, :] * torch.Tensor(pos_uncertainty).to(gt_device).reshape((len(pos_uncertainty),1)) 
